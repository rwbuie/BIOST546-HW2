...
DF <- data.frame(X1 = c(rnorm(50,0,STANDARDDEV),
                        rnorm(50,findit(DOTDISTANCE,315,"x"),STANDARDDEV),
                        rnorm(50,findit(DOTDISTANCE,45,"x"),STANDARDDEV)) ,
                 X2=  c(rnorm(50,-DOTDISTANCE,STANDARDDEV),
                        rnorm(50,findit(DOTDISTANCE,315,"y"),STANDARDDEV),
                        rnorm(50,findit(DOTDISTANCE,45,"y"),STANDARDDEV)) , 
...
ggplot(DF, aes(x = X1,y=X2, color=as.factor(Type))) +
  ...
  geom_segment(aes(x=0, y=0, xend = 0, yend=linelength), color = "black") +
  geom_segment(aes(x=0, y=0, xend = findit(linelength,135,"x"), yend=findit(linelength,135,"y")), color = "black") +
  geom_segment(aes(x=0, y=0, xend = findit(linelength,225,"x"), yend=findit(linelength,225,"y")), color = "black")
